...
import image from '../../../../src/assets/daycare-img-1.png'
...
const Textimg = () => (
  <section>
    ...
    <div className="text-img-text2">
      <h2>Overview</h2>
      <p>Park House Residential Care Home also offer a range of Day Care Services (subject to availability) which can be provided between the hours of 07:00hrs and 22:00hrs, a day care service package is tailored to the times you require and can be used on an ad-hoc basis providing your details are regularly reviewed.</p>
